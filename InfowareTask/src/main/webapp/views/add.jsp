...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-sm-12 d-flex justify-content-center text-success" ><b> ${result1}</b> </div>
    </c:if>
  ...
  <input type="text" class="form-control" placeholder="firstName" aria-label="Username" aria-describedby="addon-wrapping" required name="firstName" minlength="3" maxlength="15">
</div>
<div class="input-group flex-nowrap m-1">
 
  <input type="text" class="form-control" placeholder="lastName" aria-label="Username" aria-describedby="addon-wrapping" required name="lastName" minlength="3" maxlength="15">
</div>
<div class="input-group flex-nowrap m-1">
...
<div class="input-group flex-nowrap m-1">
  ...
  <input type="tel" class="form-control" placeholder="phoneNo" aria-label="Username" aria-describedby="addon-wrapping" required name="phoneNo" minlength="10" maxlength="10">
</div>
