...
<html lang="en">
  <head>
    ...
    <title>Infoware Task</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">
  </head>
  <body>
    <div class="container mt-2 border p-5 shadow-lg border border-danger-subtle">
    <div class="row shadow p-2 ">
    <span class="fw-bold fst-italic bg-danger text-dark p-2 w-25 p-1 ">Infoware Internship Task</span>
    <div class="col-md-12 m-2 justify-content-center d-flex">
  ...
  <a  href="/show_update" class="btn  btn-outline-primary fw-bold" type="button"><h3>Update Employee</h3></a>
</div></div>
    <div class="col-sm-12 m-2">  <div class="d-grid gap-2 col-6 mx-auto">
...
<div class="col-sm-12 m-2">
    <div class="d-grid gap-2 col-6 mx-auto">
  <a href="/get_pagination" class="btn btn-outline-success fw-bold" type="button"><h3>Pagination View</h3></a>
</div>
    </div>
